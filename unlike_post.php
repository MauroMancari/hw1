<?php
    #RIMUOVO IL LIKE CHE E' STATO ASSOCIATO ALL'UTENTE LOGGATO.
    ...
    /*
        QUESTA VOLTA ELIMINO L'ENTRY DEI LIKES, ATTIVO IL TRIGGER PER LA RIMOZIONE DEI LIKE 
        E MI RICAVO IL NUOVO NUMERO DI LIKE.
    */ 
